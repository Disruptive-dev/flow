...
const translations = {
  en: {
    ...
    tagline_find: "Find. Clean. Activate. Convert.",
    tagline_desc: "Spectra Flow finds, cleans, activates and converts business opportunities from a single premium platform.",
